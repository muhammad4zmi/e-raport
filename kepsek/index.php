...
$cek_user = mysqli_query($link, "select tbl_guru.nip,tbl_guru.nama_guru,tbl_guru.jk,tbl_user.nip from tbl_user,tbl_guru where tbl_user.nip=tbl_guru.nip and tbl_user.nip='" . $_SESSION['admin-kepsek'] . "'");
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header bg-light-blue">
                                ...
                                <p>
                                    <?php echo $nama_guru; ?>
                                    <small><?php echo $_SESSION['jabatan']?><br/></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                    ...
                    <li class="active">
                     ...
                     <li class="active">
                        <a href="?admin=statistik">
                            <i class="fa fa-book fa-fw"></i> <span>Statistik</span>
                        </a>
                    </li>
