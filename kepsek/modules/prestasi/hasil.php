   ...
   <form class="form-horizontal" method="POST" action="?admin=ubah_prestasi" >
       <fieldset>
           <div class="form-group">
            ...
            <div class="col-lg-8">
                <input class="form-control" id="nama_mhs" type="text" name="prestasi" value="<?php echo $j['nama_prestasi'] ?>" required/>
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input class="form-control"  id="tanggal" type="date" name="waktu" value="<?php echo $j['waktu']?>" required/>
