...
$link1 = mysqli_connect("localhost", "root", "", "db_raport");
 ...
 FROM tbl_nilai,tbl_kelas,tbl_siswa where tbl_nilai.id_kelas=tbl_kelas.id_kelas and tbl_nilai.nis=tbl_siswa.nis and tbl_siswa.nis='$nis' ";
...
<?php 
  ...
  $nis=$_GET['nis'];
     ...
     $k=mysqli_query($link1,"select nilai_akhir as jml,semester,kd_mapel,id_kelas from rekap_nilai where nis='$nis' order by id_kelas");        
  $q=mysqli_query($link1,"SELECT rekap_nilai.nis,rekap_nilai.semester,tbl_kelas.id_kelas,tbl_kelas.kelas,tbl_mapel.kd_mapel,
        ...
        where rekap_nilai.id_kelas=tbl_kelas.id_kelas and rekap_nilai.kd_mapel=tbl_mapel.kd_mapel and rekap_nilai.nis='$nis'");
