...
<aside class="right-side">
 ...
 <h3 class="page-header"><i class="fa fa-book fa-fw fa-2x"></i> Halaman Ubah Nilai Mapel<b><strong> 
...
<div class="row-fluid placeholders">
    <div class="col-md-12 text-left">
       ...
       <div class="panel panel-primary" id="cetak">
                    <!-- Default panel contents -->
                    <div class="panel-heading">Ubah Nilai Berdasarkan Semester</div>
                    <div class="panel-body">
                    ...
                    <br/>
                        ...
                        <div class="tab-pane active" id="in" >
                            <div class="box-body table-responsive" id="data-mahasiswa">
                                  ...
                                  <form action="?admin=ubah_nilai" method="POST" name='autoSumForm' id="isinilai" class="form-horizontal">  
                                ...
                                if ($jml_lap > 0) {
                                        ...
                                        while ($data_nilai = mysqli_fetch_array($sql_detail)) {
                                           ...
                                           <tr>
                                                <td><?php echo $no; ?></td>
                                                <td>
                                                     <input class="form-control" type="hidden"  name="id_rekap[]" id="kelas" value="<?php echo $data_nilai['id_rekap']?>" readonly>
                                                    <?php echo "<input class='form-control' type='text' id='nis' name='nis[]' value='".$data_nilai['nis']."' readonly> "?></td> 
                                                 <td><?php echo $data_nilai['nama_lengkap']; ?>
                                                     <?php echo "<input class='form-control' type='hidden' id='kd_mapel' name='kd_mapel[]' value='".$data_nilai['kd_mapel']."' readonly> "?>
                                                 </td>
                                                 
                                                <td><?php echo "<input class='form-control' type='text' id='harian' name='harian[]'' required value='".$data_nilai['nilai_harian']."'>"; ?>
                                                </td> 
                                                 <td><?php echo "<input class='form-control' type='text' id='harian' name='mid[]'' required value='".$data_nilai['nilai_mid']."'>"; ?>
                                                </td>  
                                                <td><?php echo "<input class='form-control' type='text' id='harian' name='uas[]'' required value='".$data_nilai['nilai_uas']."'>"; ?>
                                                </td>
                                                <td><?php echo "<input class='form-control' type='text' id='harian' name='hariank[]'' required value='".$data_nilai['nilai_hk']."'>"; ?>
                                                </td>
                                                <td><?php echo "<input class='form-control' type='text' id='harian' name='uask[]'' required value='".$data_nilai['nilai_midk']."'>"; ?>
                                                </td>
                                                 <td><?php echo "<input class='form-control' type='text' id='harian' name='midk[]'' required value='".$data_nilai['nilai_usk']."'>"; ?>
                                                </td>
                                                 <input class="form-control" type="hidden"  name="kkm[]" id="kelas" value="<?php echo $data_nilai['kkm']?>" readonly>
                                                    <input class="form-control" type="hidden"  name="kelas[]" id="kelas" value="<?php echo $data_nilai['id_kelas']?>">
                                                  <input class="form-control" type="hidden"  name="semester[]"  value="<?php echo $data_nilai['semester'];?>">
