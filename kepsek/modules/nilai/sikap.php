...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Nilai Sikap</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active">Data Sikap</li>
        </ol>
    </section>
    <section class="content">
        <h3 class="page-header"><i class="fa fa-smile-o fa-fw fa-2x"></i> Halaman Nilai Sikap
            </h3>
        ...
        //             $start = ($page - 1) * $per_hal;
                    $sql_sikap = mysqli_query($link, "SELECT * from tbl_sikap order by id asc");
                    $j = mysqli_num_rows($sql_sikap);
                    if ($j > 0) {
                        ?>
                        <div class="panel panel-primary">
                            <!-- Default panel contents -->
                            <div class="panel-heading"><i class="fa fa-list fa-fw fa-2x"></i> Data Nilai Sikap</div><br/>
                            <div class="panel-body">
                            <table id="example1" class="table table-striped table-hover table-condensed">
                                <thead>
                                    <tr>
                                        <th width="3%">#</th>
                                        <th width="5%">Sikap Spritual</th>
                                        <th width="20%">Deskripsi</th>
                                        <th width="5%">Sikap Sosial</th>
                                        <th width="20%">Deskripsi</th>
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    while ($data_sikap = mysqli_fetch_assoc($sql_sikap)) {

                                        ?>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $data_sikap['p_spritual']; ?></a></td>
                                            <td><?php echo $data_sikap['desk_spritual']; ?></td>
                                            <td><?php echo $data_sikap['p_sosial']; ?></td>
                                            <td><?php echo $data_sikap['desk_sosial']; ?></td>

                                            
                                            <td>

                                                <a href="#" class="edit-record" data-id="<?php echo $data_sikap['id'];?>" title="" data-original-title="">
                                                    <button type="button" class="btn btn-info btn-flat btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                                                </a>
                                                <a href="#" data-href="index.php?admin=del_sikap&id=<?php echo $data_sikap['id']; ?>" data-toggle="modal" data-target="#confirm-delete">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil fa-fw fa-lg"></i> Tambah Data Sikap</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="?admin=add_sikap" >
                    <fieldset>
                       <div class="form-group">
                        <label class="col-lg-3 control-label">Nilai Spritual</label>
                        <div class="col-lg-8">
                            <input class="form-control" id="nama_mhs" type="text" name="p_spritual" placeholder="Spritual" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea type="text" id="deskripsi" name="desk_spritual" class="form-control" required></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" id="nama_mhs" type="text" name="p_sosial" placeholder="Sosial" required/>
               ...
               <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea type="text" id="deskripsi" name="desk_sosial" class="form-control" required></textarea>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil fa-fw fa-lg"></i> Ubah Nilai Sikap</h4>
            </div>
            <div class="modal-body">
...
<script>
  $(function(){
    $(document).on('click','.edit-record',function(e){
        e.preventDefault();
        $("#myEdit").modal('show');
        $.post('modules/nilai/hasil-sikap.php',
