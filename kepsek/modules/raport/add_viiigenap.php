<?php
      ...
      $sql1="INSERT INTO presensi (alfa,izin,sakit,pribadi,akhlak,id_kelas,semester,nis,pesan_wali)
                       values('$alfa','$izin','$sakit','$pribadi','$akhlak','$kelas','$semester','$nis','$pesan')";
