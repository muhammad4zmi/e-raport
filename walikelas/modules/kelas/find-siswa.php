...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_laporan = mysqli_query($link, "SELECT tbl_kelas.id_kelas,tbl_kelas.kelas,tbl_siswa.nis,tbl_siswa.nama_lengkap,tbl_siswa.alamat
                from tbl_kelas INNER JOIN tbl_siswa ON tbl_kelas.nis=tbl_siswa.nis where tbl_siswa.nis like '%" . $cari . "%'
                    					order by nis asc");
        ...
        <div class="col-md-12 text-left">
            ...
            if ($hsl > 0) {
                ...
                <div class="alert alert-success fade in">
                    ...
                    <p>
                        <a type="button" class="btn btn-warning" href="?admin=dt_kelas"><i class="fa fa-backward"></i> Kembali Ke Menu Siswa</a>
                ...
                <th width="10%">Aksi</th>
                    ...
                    <tbody>
                        ...
                        <div class="alert alert-danger fade in">
                            ...
                            <p>
                                <a type="button" class="btn btn-danger" href="?admin=dt_kelas"><i class="fa fa-backward"></i> Kembali Ke Menu Lihat Siswa</a>
            ...
            <div class="alert alert-danger fade in">
                ...
                <p>
                    <a type="button" class="btn btn-warning" href="?admin=dt_kelas"><i class="fa fa-backward"></i> Kembali Ke Menu Lihat Kelas</a>
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#CariLagi"><i class="fa fa-search-plus"></i> Ulangi Pencarian</button>
                </p>
            </div>
            <?php
