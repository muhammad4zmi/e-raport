                    ...
                    <p>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#" data-toggle="modal" data-target="#Tambah"><i class="fa fa-user fa-lg"></i> Data User</a></li>
                            </ul>
                        </div>
                        <br/>
                    </p>
                ...
                <form class="form-horizontal" method="POST" action="?admin=add-user" >
                    <fieldset>
                      <div class="form-group">
                             ...
                             <div class="col-lg-8">
                                <select name="nip" id="nis" multiple="multiple" style="width: 370px" class="form-control">
                                    <?php
