...
$data = new Spreadsheet_Excel_Reader($_FILES['filemapel']['tmp_name']);
...
//                 <strong>Upps..!!</strong>
//                 Maaf, Data Mapel yang Anda Masukkan ada yang Duplicate.!!
...
// }else{
     ...
     $query = "INSERT INTO tbl_mapel (kd_mapel,  nama_mapel, kkm) 
      VALUES ('$kd_mapel', '$nama_mapel','$kkm')";
