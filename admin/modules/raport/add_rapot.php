...
$sql_mapel = mysqli_query($link,"SELECT tbl_siswa.nis,tbl_siswa.nama_lengkap,tbl_kelas.id_kelas
            ...
            rekap_nilai.id_kelas=tbl_kelas.id_kelas and tbl_kelas.id_kelas='$id_kelas' and rekap_nilai.nis='$nis' group by 
            tbl_siswa.nis");
...
$dt_mhs = mysqli_query($link, "SELECT tbl_siswa.nis,tbl_siswa.nama_lengkap,tbl_kelas.id_kelas,
          ...
          where tbl_siswa.nis=tbl_kelas.nis and tbl_siswa.nis=rapot.nis and tbl_kelas.id_kelas='$id_kelas' and tbl_siswa.nis='$nis' 
...
<div class="row-fluid placeholders">
    <div class="col-md-12 text-left">
       <div class="alert alert-warning">
        <h4>Perhatian!</h4>
        <p>
            1. Silahkan Klik Kelas kemudian<br>
            2. Pilih Semester Berlangsung dan klik tombol <strong>Isi Data</strong> Untuk mulai mengisi Raport.
        </p>
    </div>
       ...
       <div class="panel panel-primary">
                    ...
                    <div class="tabs-x tabs-above tab-align-left tab-bordered">
                     <ul id="w1" class="nav nav-tabs" role="tablist">
                        ...
                        <?php
                $cek_angk = mysqli_query($link, "select kelas from tbl_kelas where id_kelas='$id_kelas' and nis='$nis' group by kelas");
                ...
                $cek_angk2 = mysqli_query($link, "select tbl_kelas.id_kelas,tbl_kelas.kelas,
                    ...
                    tbl_walikelas.nip=tbl_guru.nip and tbl_kelas.nis='$nis' and tbl_kelas.id_kelas='$id_kelas'");
