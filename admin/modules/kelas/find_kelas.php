            ...
            <div class="modal-body">
                Isi Data Pencarian : <form class="navbar-form" method="POST" action="?admin=cari_kelas">
                   <div class="input-group">
                    ...
                    <input type="text" class="tultip form-control" name="cari" placeholder="Cari Kelas..." required="" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="Cari Berdasarkan Kelas">
                </div>
