...
if (isset($_POST['reset_akun']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $r_akun = mysqli_query($link, "update akun set nis='" . $rnis . "',password='" . md5($passwd1) . "',
                            password2='" . $passwd2 . "' where nis='" . $rnis . "'");
    if ($r_akun) {
 ...
 <section class="content">
        <div class="alert alert-success fade in">
            ...
            <p>Password Akun Dengan Nis <b><?php echo $rnis; ?></b> dan Username <b><?php echo $rusername; ?></b> Berhasil Dirubah</p>
        </div>
        <?php
    ...
    ?>
    <p>
        <a href="?admin=pengaturan" class="btn btn-danger"><i class="fa fa-chevron-left fa-lg"></i> Kembali Ke Pengaturan</a>
    </p>
     </section>
</aside>
    <?php
