                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="?admin=proses_akun">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo $r_dt['nis']; ?>" name="rnis" readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">username</label>
                                <div class="col-sm-10">
                                    <input type="username" class="form-control" value="<?php echo $r_dt['nis']; ?>" name="rusername" readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <a class="btn btn-danger" href="?admin=pengaturan">Batal <i class="fa fa-times"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
