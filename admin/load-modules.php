...
switch ($module) {
    ...
    break;
    case 'del_nilai':
        require("modules/nilai/del_nilai.php");
        break;
    //------------Route Untuk Halaman Data Mapel------------//
    case 'add_jadwal':
        require("modules/jadwal/add_jadwal.php");
        break;
    case 'ubah_jadwal':
        require("modules/jadwal/ubah_jadwal.php");
        break;
    case 'del_jadwal':
        require("modules/jadwal/del_jadwal.php");
        break;
    case 'dt_mapel' :
    ...
    break;
    case 'jadwal' :
    require("modules/jadwal/index.php");
    break;
    ...
    break;
    case 'cari-siswa':
        require("modules/raport/find-siswa.php");
        break;
    case 'raport' :
...
//import
    case 'import_siswa' :
    require("modules/upload/proses_siswa.php");
    break;
    case 'import_guru' :
    require("modules/upload/proses_guru.php");
    break;
    case 'import_mapel' :
    require("modules/upload/proses_mapel.php");
    break;
    case 'import_jadwal':
    require("modules/upload/proses_jadwal.php");
        # code...
        break;
    case 'import_nilai':
 ...
 case 'info' :
    ...
    break;
    case 'import_kelas' :
    require("modules/upload/proses_kelas.php");
    break;
